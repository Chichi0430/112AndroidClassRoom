...
public class MainActivity extends AppCompatActivity {
    ...
    protected  void  onPause() {
        ...
        int tempinput = 0;
        SharedPreferences.Editor newItem = prefsEditor.putString("newItem", (Integer.valueOf(tempinput)).toString());
        prefsEditor.commit();
    }
    @Override
    protected  void  onResume() {
        ...
        theValue=(new String((appshareprefs.getString("newItem","0"))));
    }
